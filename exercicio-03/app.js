...
const maleDogs = ['Chico', 'Zeca'];
const femaleDogs = ['Lilica', 'Matilda'];

let dogNames = maleDogs.concat(femaleDogs);
...
const initials =
    dogNames[0][0] + dogNames[1][0] + dogNames[2][0] + dogNames[3][0];

console.log(initials, dogNames);
...
const dessert =
    dogNames[0].slice(3) + dogNames[1].slice(2) + dogNames[3].slice(2);
