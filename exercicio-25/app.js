...
console.log('1o exercise: ', months.indexOf('Fevereiro'));
...
const past = new Date('jul 30 1984 6:00');
console.log({ past });
...
console.log('5o exercise: ', past.getHours());
...
const future = new Date('2021/07/30 6:15:00');
console.log({ future });
