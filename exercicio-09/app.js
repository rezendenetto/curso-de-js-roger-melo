...
console.log(convertToString(1984), typeof convertToString(1984));
...
console.log(getStringLength('Rezende'));
...
console.log(getIndex('z', 'Rezende'));
...
console.log(isItemIncluded('Neto', ['Lara', 'Neto', 'Rômulo']));
...
console.log(concatArrays(['oi', 'ola'], ['hi', 'hello']));
...
const removeLastItem = array => {
    array.pop(); // deixar o código ser executado nessa linha
    return array; // e aqui retornar o array
};
...
const getLikesMessage = (names = []) => {
    ...
    switch (names.length) {
        case 0:
            return 'Ninguém curtiu isso.'; // return elimina a necessidade de usar o break
        case 1:
...
console.log(getLikesMessage(['neto', 'lara', 'romulo', 'ze', 'pedro', 'joão']));
