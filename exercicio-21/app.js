...
const oddNumbers = randomNumbers.filter(getOddNumbers); //desacoplar a função de callback e nomear o que ela faz
...
// ATENÇÃO:
// - Após a refatoração de if pra ternário, precisei usar o pré incremento e não o pós incremento, já que o incremento e o return estão na mesma linha de código
const countNumbersLessThan501 = (accumulator, crazyNumber) =>
    crazyNumber < 501 ? ++accumulator : accumulator;

const numbersLessThan501 = crazyNumbers.reduce(countNumbersLessThan501, 0); //desacoplar a função de callback e nomear o que ela faz
...
// debugger;
// o debugger é um breakpoint que nos permite pausar e examinar o código nesse exato momento
// substitui o uso do console.log ???
